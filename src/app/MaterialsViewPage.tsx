    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mt-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 mt-4 gap-4 text-center">
            <div>
              <p className="text-xs sm:text-sm text-green-600 font-bold uppercase tracking-tight">Order Placed</p>
              <p className="text-[10px] sm:text-xs text-green-600 mt-1 font-medium">2024-01-15</p>
            </div>
            <div>
              <p className="text-xs sm:text-sm text-green-600 font-bold uppercase tracking-tight">Approved</p>
              <p className="text-[10px] sm:text-xs text-green-600 mt-1 font-medium">2024-01-18</p>
            </div>
            <div>
              <p className="text-xs sm:text-sm text-gray-400 font-bold uppercase tracking-tight">Dispatched</p>
            </div>
            <div>
              <p className="text-xs sm:text-sm text-gray-400 font-bold uppercase tracking-tight">Delivered</p>
            </div>
          </div>
        </div>
      </div>
